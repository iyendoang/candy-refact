<?php
$id_mapel = $_GET['id'];
$mapelQ = mysqli_query($koneksi, "SELECT * FROM mapel LEFT JOIN mata_pelajaran ON mata_pelajaran.kode_mapel=mapel.nama where id_mapel='$id_mapel'");
    ...
    <div class='col-md-12'>
        ...
        <div class='box box-solid'>
            <div class='box-header with-border'>
                <h3 class='box-title'>Import Soal [ <span style="color: #000;"><?= $mapel['kode']; ?></span> ] - <?= ucfirst(strtolower($mapel['nama_mapel'])); ?></h3>
            ...
            <div class='box-body'>
                <div class='col-md-4'>
                    <form id="formsoalcandy" method='post' enctype='multipart/form-data'>
                        <div class='box box-solid'>
                            <div class='box-header with-border'>
                                <h3 class='box-title'>Import Soal Ms Excel</h3>
                                <div class='box-tools pull-right '>
