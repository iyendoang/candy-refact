        ...
        <table class='table table-bordered table-striped ' id="example1">
            ...
            <tbody>
                ...
                if ($pengawas['level'] == 'admin') {
                    ...
                    $mapelQ = mysqli_query($koneksi, "SELECT * FROM ujian 
                    JOIN mapel ON ujian.kode_nama = mapel.kode 
                    JOIN pengawas ON pengawas.id_pengawas = mapel.idguru  
                    WHERE mapel.idguru = '$id_pengawas' OR  ujian.id_guru='$id_pengawas'
                    ORDER BY tgl_ujian ASC, waktu_ujian ASC");
                }
                ?>
