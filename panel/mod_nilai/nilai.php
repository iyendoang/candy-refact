...
<?php if ($ac == '') : ?>
	...
	$sqlkelas = "";
	if (!$kelas == 'semua') {
		$sqlkelas = "where id_kelas in ('" . $kelas . "')";
	}
			...
			<div class='box box-solid'>
				<div class='box-header with-border'>
					...
					<div class='box-tools pull-right btn-grou'>
						...
						<a class='btn btn-sm btn-success' href='mod_nilai/report_excel.php?m=<?= $id_ujian ?>'><i class='fa fa-download'></i> Download Excel</a>
				...
				<div class='box-body'>
					<div id="tablenilai" class='table-responsive'>
						<table id="tablenilaix" class='table table-bordered table-striped'>
							...
							<tbody>
								<?php $siswaQ = mysqli_query($koneksi, "SELECT * FROM siswa  " . $sqllevel . $sqlkelas); ?>
