		...
		<?php while ($siswa = mysqli_fetch_array($siswaQ)) : ?>
			...
			<tr>
				...
				<?php while ($mapel = mysqli_fetch_array($mapelQ)) : ?>
					...
					?>
					<td style="text-align:center" class="str"><?= $nilai['jml_benar'] ?></td>
					<td style="text-align:center" class="str"><?= $nilai['jml_salah'] ?></td>
					<td style="text-align:center" class="str"><?= $nilai['nilai_esai'] ?></td>
					<td style="text-align:center" class="str"><?= number_format($nilai['total'], 2) ?></td>
				<?php endwhile; ?>
			</tr>
		<?php endwhile; ?>
	</tbody>
