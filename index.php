        ...
        <div class='content-wrapper' style='background-image: url(dist/backgroun.jpg);background-size: cover;'>
            ...
            <section class='content' style="margin-top:-95px">
                ...
                <?php elseif ($pg == 'lihathasil') : ?>
                    ...
                    $ujian = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM ujian WHERE id_ujian='$ac'"));
                    if ($nilai['hasil'] == 1 ||   $ujian['hasil'] == 1) :
                                                ...
                                                <div class="tab-pane" id="tab_2">
                                                    <table class='table-responsive'>
                                                        <table id='example1' class='table table-striped'>
                                                            ...
                                                            <tbody>
                                                            <?php $nilaix = mysqli_query($koneksi, "SELECT * FROM nilai WHERE id_ujian='$ac' ORDER BY CAST(total AS DECIMAL) DESC"); ?>
                                                                <?php $no = 0; ?>
                                                                <?php while ($peringkat = mysqli_fetch_array($nilaix)) : ?>
                                                                    ...
                                                                    <tr <?= $style ?>>
                                                                        ...
                                                                        <td><?= $siswa['nama'] ?></td>
                                                                        <td style="text-align:center"><?= number_format($peringkat['total'], 2) ?></td>
                                                                    </tr>
                                                                <?php endwhile; ?>
                                                            </tbody>
                                                        </table>
