...
<head>
	...
	<link rel="icon" type="image/png" href="../dist/img/book.ico" />
...
<body style="background-color: #999999;">
	<div class="limiter">
		<div class="container-login100">
			...
			<div class='logo hidden-xs'><img class='img img-responsive' style='max-width:200px;' src="<?php echo "../$logo"; ?>" width='150'></div>
			<div class="login100-more" style="background-image: url('../<?= $image_background ?>');"></div>
